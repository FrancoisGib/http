...
#ifdef HTTP_TREE_MAIN

int main()
{

   tree_t *http_tree = init_http_tree("fdsfs", ET_PATH, HTML);

   char home[] = "home/ok";
   add_endpoint(http_tree, home, "<p>Home</p>", ET_TEXT, HTML);

   char home2[] = "home/index";
   add_endpoint(http_tree, home2, "<p>Home</p>", ET_TEXT, HTML);

   char home3[] = "ok/a";
   add_endpoint(http_tree, home3, "<p>Home</p>", ET_TEXT, HTML);

   char home4[] = "ok/b";
   add_endpoint(http_tree, home4, "<p>Home</p>", ET_TEXT, HTML);

   char home5[] = "ok/b/c";
   add_endpoint(http_tree, home5, "<p>Home</p>", ET_TEXT, HTML);

   char home6[] = "ok/b/c/d";
   add_endpoint(http_tree, home6, "<p>Home</p>", ET_TEXT, HTML);

   char home7[] = "home/index/main";
   add_endpoint(http_tree, home7, "<p>Home</p>", ET_TEXT, HTML);

   print_http_tree(http_tree, 0);

   char endpoint_request[] = "";
   endpoint_t *endpoint = get_endpoint(http_tree, endpoint_request);
   if (endpoint != NULL)
